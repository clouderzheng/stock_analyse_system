...
"""定时任务更新最新股票信息 每天下午4点"""
scheduler.add_job(snow_ball_service.get_stock_last_info, 'cron', hour=14,minute=57)
"""定时任务爬取所有股票信息"""
scheduler.add_job(query_all_stock_service.query_stock, 'cron', hour=12,minute=2)
